...
const NameForm = (props) => {
  const {nome,idade,email,onChangeNome,onChangeIdade,onChangeEmail,sendData,confirmaEmail,onChangeconfirmaEmail}=props
  return (
    <Form>
        <label>
          Nome:
        ...
        <label>
          ...
          <Input  placeholder="usuario@usuario.com" value={confirmaEmail} onChange={onChangeconfirmaEmail}/>
        </label>
